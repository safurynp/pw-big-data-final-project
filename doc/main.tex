...
% Opisz co oznacza analisza big data - wykorzystanie narzedzi ... (sprawdz strone Microsoft)
...
% Starting new EMR cluster everytime I wanted to run a Jupyter notebook was time consuming. Maybe I should have automated the process somehow (AWS CLI?)

% Clean up some Notebook code - e..g. define functions instead of repeating code with different parameters.

% Przeanalizowanie podobnych zaleznosci w profesjonalnym tenisie żeńskim (WTA), nie tylko męskim (ATP)

% More cleaing with the winner_ht and loser_ht especially in the WTA data
